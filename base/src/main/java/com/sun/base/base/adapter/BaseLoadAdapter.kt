...
open class BaseLoadAdapter<VB : ViewBinding, T> : RecyclerView.Adapter<BaseViewHolder<VB, T>>() {
    ...
    var onLongClick: ((position: Int, action: Any) -> Unit)? = null
    var onOtherClick: ((position: Int, action: Any) -> Unit)? = null
    ...
    protected open fun setParams():Any{
        return ""
    }
